...
FAGGOTCUNT:= WINEXIST explorer.exe
...
Runwait, %comspec% /c convert BLAH.%inExtension% -resize "256x256^" -gravity center -crop 256x256+0+0 +repage -alpha Set -background none -vignette 0x10-10-10 +repage -depth 8  %out3%,,hide
/* 
