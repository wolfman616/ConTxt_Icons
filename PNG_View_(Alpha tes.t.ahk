...
if 0 != 1 	; Not run with parameter
	ImagePath   := 	"S:\Documents\My Pictures\6pkB (2).gif"
else
if 0 = 1	; run with parameter from menus
	ImagePath 	= %1%
1 := ImagePath
	ImagePath   := 	"D:\Documents\My Pictures\assimil8or_by_dave_rossum.png"
...
Gui, Show, Center W%nW% H%nH% , MIDI
	gui, -Caption +AlwaysOnTop +LastFound +hwndcty -Caption -DPIScale +AlwaysOnTop +disabled -SysMenu +ToolWindow +owndialogs
