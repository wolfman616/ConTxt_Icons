...
RESIZE:="128,96,64,48,32,24,20,16"
Dest_Dir:="C:\Icon\128"
...
PNG_Create:
Runwait, %comspec% /c convert %out3% -resize "128x128^" -gravity center -crop 128x128+0+0 +repage -alpha Set -background none -depth 8  %out3%
